...
var savedgraphs = []; // JWYT - graph definitions saved on CarbixEnergyMonitor for selection
...
// path = "http://carbixenergymonitor.local"; // Temp: Local development (Can use the following Chrome extension to allow remote Ajax calls: https://chrome.google.com/webstore/detail/allow-cors-access-control/lhobafahddgcelffkeicbaginigeejlf?hl=en)
...
$("#downloadcsv").click(function() {
  ...
  element.setAttribute(
    "download",
    "carbixenergymonitor_" + moment().format("YYYY-MM-DD_HHmm") + ".csv"
  );
