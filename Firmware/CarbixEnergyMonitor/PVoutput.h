...
//  emoncms  This second cut adds support for donator mode and uses the CarbixEnergyMonitor script
...
private:
    ...
    CarbixLogRecord* oldRecord;               // Older of two log records bracketing a reporting interval
    CarbixLogRecord* newRecord;               // Newer of two log records bracketing a reporting interval
