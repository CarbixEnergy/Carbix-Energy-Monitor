 ...
 *   09/21/18 02_03_16 Add access to spiffs, maintain burden in spiffs, improve performance of carbixlog and histlog service
 ...
 *   01/18/19 02_03_21 EEprom, influx error recovery+, RTC battery warning, graph from CarbixEnergyMonitor.com
...
CarbixLog Current_log(256,5,365,32);              // current data log  (1 year)
CarbixLog History_log(256,60,3652,48);            // history data log  (10 years)
CarbixLog *Export_log = nullptr;                  // Optional export log
...
CarbixInputChannel* *inputChannel = nullptr; // -->s to incidences of input channels (maxInputs entries)
...
CarbixLogRecord statRecord;                 // Maintained by statService with real-time values
...
const uint8_t publicKey[32] PROGMEM = {
                        0x6B, 0x96, 0x0D, 0x8A, 0xAB, 0xBA, 0x02, 0xF6,
                        0xA4, 0x37, 0xA5, 0x43, 0xB6, 0x50, 0xD3, 0x0E,
                        0x73, 0xF6, 0x06, 0x71, 0xF4, 0x04, 0x4D, 0x78,
                        0x2A, 0x1E, 0x55, 0xC0, 0x2F, 0x12, 0x19, 0x4D};
