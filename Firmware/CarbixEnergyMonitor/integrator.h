...
class integrator {
    ...
    public:
        ...
        double run(CarbixLogRecord *oldRecord, CarbixLogRecord *newRecord, units Units, char method);
        void newLogEntry(CarbixLogRecord *oldRecord, CarbixLogRecord *newRecord);
        char *name();
        CarbixLog* get_log();
        bool isSynchronized();
        void end();
    ...
    protected:
        ...
        CarbixLog *_log;                  // integration log
        CarbixLogRecord *_oldRec;         // datalog records used during synchronization
        CarbixLogRecord *_newRec;
