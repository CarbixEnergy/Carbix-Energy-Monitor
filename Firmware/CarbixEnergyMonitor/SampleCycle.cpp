...
/**********************************************************************************************
  ...
  *  
  *  This code accounts for up to 66% (60Hz) of the execution of CarbixEnergyMonitor.
...
int sampleCycle(CarbixInputChannel *Vchannel, CarbixInputChannel *Ichannel, int cycles)
{
