#ifndef CarbixScript_h
#define CarbixScript_h
...
class Script {
  ...
  public:
    ...
    double  run(CarbixLogRecord* oldRec, CarbixLogRecord* newRec); // Run this Script
    double  run(CarbixLogRecord* oldRec, CarbixLogRecord* newRec, units); // Run w/overide units
    double  run(CarbixLogRecord* oldRec, CarbixLogRecord* newRec, const char* overideUnits);
  ...
  protected:
    ...
    double    runRecursive(uint8_t**, CarbixLogRecord* oldRec, CarbixLogRecord* newRec, units Units);
