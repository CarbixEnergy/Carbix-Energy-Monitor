#ifndef CarbixEnergyMonitor_h
#define CarbixEnergyMonitor_h
...
***********************************************************************************/
#define CARBIX_ENERGY_MONITOR_VERSION "02_08_03"
#define DEVICE_NAME "CarbixEnergyMonitor"
...
#include "CarbixLog.h"
#include "CarbixInputChannel.h"
#include "CarbixScript.h"
...
extern CarbixLog Current_log;
extern CarbixLog History_log;
extern CarbixLog *Export_log;
extern RTC rtc;
...
#define CARBIX_SYSTEM_DIR       "/carbixenergymonitor/"
#define CARBIX_EXPORT_LOG_PATH  "/carbixenergymonitor/export.log"
#define CARBIX_CURRENT_LOG_PATH "/carbixenergymonitor/carbixlog.log"
#define CARBIX_HISTORY_LOG_PATH "/carbixenergymonitor/histlog.log"
#define CARBIX_MESSAGE_LOG_PATH "/carbixenergymonitor/carbixmsgs.txt"
#define CARBIX_AUTH_PATH        "/carbixenergymonitor/auth.txt"
#define CARBIX_CONFIG_PATH      "/config.txt"
#define CARBIX_CONFIG_NEW_PATH  "/config+1.txt"
#define CARBIX_CONFIG_OLD_PATH  "/config-1.txt"
...
#define redLed 16                           // CarbixEnergyMonitor overusage of pins
#define greenLed 0
...
struct EEprom {
      char        id[8];                  // Valid EE area identifier "CarbixEnergyMonitor"
...
#define LED_HALT                    "R.R.R..."              // Fatal error, CarbixEnergyMonitor halted
...
extern serviceBlock* serviceQueue;     // Head of ordered list of services
      ...
      // Initial values here are defaults for CarbixEnergyMonitor 2.1.
      // VrefVolts is the declared value of the voltage reference shunt,
      // Can be specified in config.device.aref
      // Voltage adjustments are the values for AC reference attenuation in CarbixEnergyMonitor 2.1.

#define MAXINPUTS 15                          // Compile time input channels, can't be changed easily 
extern CarbixInputChannel* *inputChannel;       // -->s to incidences of input channels (maxInputs entries)
...
extern CarbixLogRecord statRecord;
...
uint32_t  logReadKey(CarbixLogRecord* callerRecord);
